...
float signal_kalman0, signal_kalman1;					//gia tri sau khi loc
...
void Filter()
{
	signal_kalman0 = kalman_single(u16Destination[0], 500, 10);
	signal_kalman1 = kalman_single(u16Destination[1], 500, 10);
